...
**Описание**: сервис представляет собой универсальный инструмент для ведения списков фильмов, сериалов, игр, книг и комиксов. В отличие от существующих решений, ориентированных на один тип медиа, Rewatch объединяет их в едином пространстве, позволяя пользователям отмечать желаемое и просмотренное, выставлять оценки, вести статистику и отслеживать прогресс.
